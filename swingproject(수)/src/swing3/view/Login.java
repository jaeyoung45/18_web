		...
		TrainView TrainView = new TrainView();
	      if (BtnLogin == null) {
	        ...
	        public void actionPerformed(ActionEvent e) {               
	                 String id = dba.login(tfId.getText(),tfPass.getText());               
	                 if(id.equals("admin") && !id.equals("비번오류")) {                        
	                	 TrainView.setVisible(true);
	                	 TrainView.btnInsert.setEnabled(true);
	                	 TrainView.TrainView.doClick();
	                       }else if (!id.equals("admin") &&!id.equals("비번오류") && !id.equals("")) {                                               
	                    	   TrainView.setVisible(true);                     
	                       }else if(id.equals("비번오류")) {
	                          new MessageBox("로그인", "비밀번호가 들렸습니다.");
	                       }else {
	                          new MessageBox("로그인", "아이디를 확인해주세요.");
	                       }
	              }
	         });
	      }

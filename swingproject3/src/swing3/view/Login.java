...
import swing3.model.TrainDBAImpl;
...
public class Login extends JFrame {
	...
	TrainDBAImpl dba= new TrainDBAImpl();
	      ...
	      if (BtnLogin == null) {
	         ...
	         BtnLogin.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e) {
	               int n = Login.dba(textField.getText(),textField.getText());
	               if(n==1) {
	                  Login ad = new Login(); 
	                  ad.setVisible(true);
	               }else if(n==2){
	...
	private JPasswordField getPasswordField() {
		if (passwordField == null) {
			...
			passwordField.setBounds(227, 211, 116, 21);
		}

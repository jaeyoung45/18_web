...
public class TrainView extends JFrame {
   ...
   JButton TrainView;
   private JButton TrainDelete;
   private JButton TrainUpdate;
   private JTextArea taView;
   private int row;
   DecimalFormat df = new DecimalFormat("###,###");
protected Object btnUpdate;
protected Object btnDelete;
   ...
   private JPanel getPanel_1() {
      if (panel_1 == null) {
         ...
         panel_1.add(getTrainDelete());
         panel_1.add(getTrainUpdate());
      }
      return panel_1;
   }
   ...
   private JButton getTrainDelete() {
      if (TrainDelete == null) {
    	 TrainDelete = new JButton("삭제");
         TrainDelete.addActionListener(new ActionListener() {            
            public void actionPerformed(ActionEvent e) {
         ...
         TrainDelete.setBounds(102, 30, 70, 23);
      }
      return TrainDelete;
   }
   private JButton getTrainUpdate() {
      if (TrainUpdate == null) {
         TrainUpdate = new JButton("수정");
         TrainUpdate.addActionListener(new ActionListener() {                     
            public void actionPerformed(ActionEvent e) {
               TrainBean t = new TrainBean();
               t.setDepart(tfDepart.getText());
               t.setArrival(tfArrival.getText());
         ...
         TrainUpdate.setBounds(188, 30, 70, 23);
      }
      return TrainUpdate;
   }
